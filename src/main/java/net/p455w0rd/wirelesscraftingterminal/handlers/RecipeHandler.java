...
public class RecipeHandler {
    ...
    public static void init() {
        ...
        easyRecipeList.add(
                new ShapedOreRecipe(
                        ItemEnum.WIRELESS_CRAFTING_TERMINAL.getStack(),
                        new Object[] { "a", "b", "c", Character.valueOf('a'), new ItemStack(multiMaterial, 1, 41),
                                Character.valueOf('b'), new ItemStack(multiPart, 1, 360), Character.valueOf('c'),
                                new ItemStack(ae2WirelessTerm, 1, 0) }));

        // Magnet Card
        easyRecipeList.add(
                new ShapedOreRecipe(
                        ItemEnum.MAGNET_CARD.getStack(),
                        new Object[] { "a b", "cdc", "ccc", Character.valueOf('a'), "dustRedstone",
                                Character.valueOf('b'), "gemLapis", Character.valueOf('c'), "ingotIron",
                                Character.valueOf('d'), new ItemStack(multiMaterial, 1, 28) }));

        // Infinity Booster Card
        easyRecipeList.add(
                new ShapedOreRecipe(
                        ItemEnum.BOOSTER_CARD.getStack(),
                        new Object[] { "abc", "ded", "cba", Character.valueOf('a'), new ItemStack(blockSpatialIO, 1, 0),
                                Character.valueOf('b'), new ItemStack(multiMaterial, 1, 42), Character.valueOf('c'),
                                new ItemStack(blockCraftingStorage, 1, 3), Character.valueOf('d'),
                                new ItemStack(multiMaterial, 1, 48), Character.valueOf('e'),
                                new ItemStack(itemWAP, 1, 0) }));
        ...
        hardRecipeList.add(
                new ShapedOreRecipe(
                        ItemEnum.WIRELESS_CRAFTING_TERMINAL.getStack(),
                        new Object[] { "aba", "cdc", "efe", Character.valueOf('a'), new ItemStack(multiMaterial, 1, 9),
                                Character.valueOf('b'), new ItemStack(itemWAP, 1, 0), Character.valueOf('c'),
                                new ItemStack(multiMaterial, 1, 12), Character.valueOf('d'),
                                new ItemStack(multiPart, 1, 360), Character.valueOf('e'),
                                new ItemStack(multiMaterial, 1, 38), Character.valueOf('f'),
                                new ItemStack(multiMaterial, 1, 47) }));

        // Magnet Card
        hardRecipeList.add(
                new ShapedOreRecipe(
                        ItemEnum.MAGNET_CARD.getStack(),
                        new Object[] { "abc", "ded", "ddd", Character.valueOf('a'), "blockRedstone",
                                Character.valueOf('b'), new ItemStack(multiPart, 1, 300), Character.valueOf('c'),
                                "blockLapis", Character.valueOf('d'), "blockIron", Character.valueOf('e'),
                                new ItemStack(multiMaterial, 1, 28) }));
    }
