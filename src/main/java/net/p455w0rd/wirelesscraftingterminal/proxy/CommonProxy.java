...
public class CommonProxy {
                ...
                if (magCompound != null) {
                    ...
                    if (magnetItem != null) {
                        ...
                        if (magnetItem.getItem() instanceof ItemMagnet) {
                            ((ItemMagnet) magnetItem.getItem())
                                    .doMagnet(magnetItem, e.player.worldObj, e.player, wirelessTerm);
                        }
                    }
                }
            }
        ...
        if (FMLCommonHandler.instance().getSide() == Side.CLIENT) {
            ...
            */
            ...
            final PacketConfigSync p = new PacketConfigSync(
                    ...
                    Reference.WCT_EASYMODE_ENABLED,
                    Reference.WCT_BOOSTER_ENABLED,
                    Reference.WCT_BOOSTER_DROPCHANCE,
                    Reference.WCT_MINETWEAKER_OVERRIDE);
    ...
    public void pickupEvent(EntityItemPickupEvent e) {
        try {
            ...
            if (playerInv == null || playerInv.player == null || world.isRemote) {
                return;
            }
