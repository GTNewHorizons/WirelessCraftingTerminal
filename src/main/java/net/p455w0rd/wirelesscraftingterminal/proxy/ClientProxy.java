...
public class ClientProxy extends CommonProxy {
    ...
    public void renderPlayer(RenderPlayerEvent.Specials.Pre event) {
        ...
        ResourceLocation location = new ResourceLocation(
                Reference.MODID,
                new String(DatatypeConverter.parseBase64Binary("dGV4dHVyZXMvY2FwZS9wNDU1Y2FwZS5wbmc=")));
            ...
            InputStream in = new URL(
                            new String(
                                    DatatypeConverter.parseBase64Binary(
                                            "aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3A0NTV3MHJkL1dpcmVsZXNzQ3JhZnRpbmdUZXJtaW5hbC9tYXN0ZXIvLnNldHRpbmdzL3BhdHJvbnMudHh0")))
                    .openStream();
