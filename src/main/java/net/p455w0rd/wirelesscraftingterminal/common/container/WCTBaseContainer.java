...
public abstract class WCTBaseContainer extends Container {
    ...
    public WCTBaseContainer(
        ...
        this.obj2 = getGuiObject(
                RandomUtils.getWirelessTerm(ip), player, player.worldObj, (int) player.posX, (int) player.posY, (int)
                        player.posZ);
        this.mySrc = new WCTPlayerSource(ip.player, this.getActionHost());
        this.prepareSync();
    }

    protected WirelessTerminalGuiObject getGuiObject(
